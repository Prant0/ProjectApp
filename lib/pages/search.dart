...
class _SearchState extends State<Search> {
  ...
  handleSearch(String query){                      //  user search kora
    ...
    return AppBar(
      ...
      title: TextFormField(
        decoration: InputDecoration(
          hintText: '    Search For Users',hintStyle: TextStyle(fontSize: 20.0,color: Colors.black),
          prefixIcon: Icon(Icons.supervisor_account,size: 30.0,),
          suffix: IconButton(
            icon: Icon(Icons.clear,size: 31.0,),
          )
        ),
    ...
    return Container(
      child: Center(
        child: ListView(
          shrinkWrap: true,
          children: <Widget>[
            SvgPicture.asset('assets/images/search.svg',height:orientation == Orientation ? 300.0 : 200.0,),

            Text('Find User',textAlign: TextAlign.center,style: TextStyle(
              fontSize: 60.0,fontStyle: FontStyle.italic,fontWeight: FontWeight.w700,color: Colors.white,
